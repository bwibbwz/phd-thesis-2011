...
The papers (\ref{part:papers}) will not be retold, but rather summarised and, where applicable, expanded on, in their respective chapters.
...
Basic understanding of vector math, calculus and basic physics is assumed.

\paragraph{\Nref{chap:pes}}
Dynamics of atomic scale systems are discussed.
The concept of a potential energy surface and its creation and interesting features are all addressed.
