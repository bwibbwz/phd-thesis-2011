...
Once this peak has been reached, the increasing demand would quickly overwhelm the production capabilities and, more importantly, the Earth's reserves.
...
Directly storing hydrogen as a gas requires a very large volume while storing it as a liquid requires cooling and pressurised tanks.
Neither is a very compelling solution for use in, for example, the average car.
Such solutions have been deployed for buses \expand
...
These storage solutions tend to have more reasonable volumetric and gravimetric densities \figmiss{energy density} but often require "unnatural" operating conditions for loading/unloading.
...
Determining the kinetics is essential. \expand
