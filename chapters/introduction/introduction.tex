...
The top point is a non-extremal stationary point (in this case, a first order saddle point) and information about the frequency of a given transition (its reaction rate) can be inferred from from it and its surroundings, which is of central importance in chemistry.~\cite{htst-wert-1949, htst-vineyard-1957}
...
\tred{(Tejs: Numbers? catalytic selectivity -> making what you want...)}
