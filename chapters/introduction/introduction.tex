...
Such solutions have, nevertheless, been deployed in buses \expand
...
Currently this process depends on rare elements, such as platinum, to catalyse the reaction.
\expand
Investigating catalytic activity and designing cheap, efficient, catalysts is highly dependant on information on the kinetics of \expand

\subsubsection{Summary}
Information about non-extremal stationary points is highly useful in designing and implementing the future.
Helping to understand the problems of the past and design novel materials for the future.
