...
\figmiss{Showing a few general SDPs and at least one MEP and one ridge, High priority}
...
Of course, MEPs do not exists near \sap{2}s, and the anlogue ends there as the criterion for a ridge demands a negative eigenvalue in the reduced Hessian, perpendicular to the path.
