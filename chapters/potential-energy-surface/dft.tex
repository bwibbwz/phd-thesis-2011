...
However, since the main focus of this thesis is not aimed at the specifics of DFT, its specific implementations will not be discussed further and the reader is referred to the specific papers with regards to which implementation was employed and what parameters used.
