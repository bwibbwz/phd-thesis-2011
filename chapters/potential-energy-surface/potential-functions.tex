...
Such potentials are very helpful during the development of methods and two such, EMT~\cite{emt-1987} and EAM~\cite{eam-1983} were extensively used for testing the novel method presented in \fref{chap:erm} and paper \ref{pap:second-order}.
...
Simple and quick test cases using EMT~\cite{emt-1996} --- which operates under similar approximations as EAM --- served to produce PESes that could be visualised in two dimensions, while still retaining the properties of truly multidimensional systems in \fref{chap:erm}.
While more extensive tests were carried out in \fref{chap:al} on systems that are known to be described well with analytical PESes, i.c. EAM.
