...
Furthermore, if tuning the parameters of the potential well enough is possible, the potential can be used to perform calculations that are infeasable for quantum methods, such as long term molecular dynamics of large systems.~\citemiss
...
EAM has been parameterised very well, e.g. for \ce{Al} surfaces using DFT data~\cite{eam-1986} and used successfully in studies of the self-diffusional mechanisms on the \ce{Al}(100) surface~\cite{dimer-original-1999}
