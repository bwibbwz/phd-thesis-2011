...
\tred{(Tejs: Here, the EAM implementation has been chosen, due to the amount of data available on Al. Other implementations like EMT, Finnis-Sinclaire...)}\tblue{(I already talk about Al later in the section...)}
