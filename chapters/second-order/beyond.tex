...
In the tests presented in \fref{chap:al}, $\Gamma > 1.0$ was not a common, even though the infinite limits were used, and thus did not offer the opportunity to discuss such ratios further or investigate the effect of the limits in detail.
%nor large problem compared with the factors where $\Gamma < 1.0$ and thus the infinite limits were used.
