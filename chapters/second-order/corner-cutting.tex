...
\subsubsection{Detecting corner cutting}
\placeholder

\subsection{Minimise conrner cutting}
\emph{This section is speculative and serves as an outlook than a complete discussion.}
