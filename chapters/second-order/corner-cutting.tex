...
Either converging points $i_\text{max} \plusminus 1$ and then locking them in place (similar to the CI) and then converging points $i_\text{max} \plusminus 2$, etc.
