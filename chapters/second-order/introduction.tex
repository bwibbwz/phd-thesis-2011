...
A collection of two specific steepest descent paths starting infinitesimally close to a \sap{2} and ending at two neighbouring \sap{1}s can be considered a ridge (see \fref{fig:paths}).
