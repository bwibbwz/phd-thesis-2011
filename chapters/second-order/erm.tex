...
\end{equation}
where the first term is the transformed force from \fref{eq:minmode-force}%,
%the second term removes any components of the transformed force parallel to the path,
and the %third 
second term is the spring force from \fref{eq:full-spring-force} that controls the distribution of the images along the path and increases numerical stability.
...
%The climbing image \cite{neb-ci-2000} algorithm decouples the highest energy image from the springs and inverts the force along the tangent in a manner similar to \fref{eq:minmode-force}\cite{neb-ci-2000},
