...
Simply using the Dimer, or any other non-exact, estimate of the minimum mode introduces instabilities in the forces, as the ridge$\rightarrow$MEP mapping can be inaccurate.
This, directly, is not a problem hindering convergence since the Dimer has \expand
