...
Either the transitioning hydrogen atom would "jump" from one oxygen atom to the next near a titanium atom (as seen for atom A in \fref{fig:semi-combined} and \ref{fig:jump-combined}) or it would "rotate" past a strontium atom while remaining near the same oxygen atom (as seen for atom B in \fref{fig:jump-combined}).
...
\begin{center}
  ...
  \subfigure[Energy profile of the ridge. The \sap{2} is $\mytilde 0.08\unit{eV}$ higher than the A-jump \sap{1}]{
    \includegraphics[width=0.45\linewidth]{semi-ridge}
    \label{fig:semi-ridge}
    }
    \parbox{0.85\linewidth}{
      \caption{\ce{SrTiO3} with a double hydrogen defect.
A successful DFT ridge calculation between a jump \sap{1} for hydrogen atom A and rotation of hydrogen atom B.
...
Both the \sap{2}s are on the border of the $5\kB T$ limit. 
Furthermore, finding multiple low energy \sap{2}s and a flat energy profile are clear warning signs, that the HTST rate could be improved.
