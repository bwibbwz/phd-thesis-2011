...
\Fref{fig:ca-pes01} shows that a $C_3$ axis will is low in energy and that a wobbly $C_2$ axis with a small intermediate minimum is second lowest.
Using these as the starting paths for NEB calculations we find the MEPs shown overlayed in \fref{fig:ca-pes01} and as energy profiles in \fref{fig:ca-barriers}.
