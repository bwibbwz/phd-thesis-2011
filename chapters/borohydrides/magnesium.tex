...
The general result from the PESes was that rotations that maximise the \ce{H}-\ce{Mg} distance, $d_{H-Mg}$, showed the lowest energies (\fref{fig:h-mg-distances}).
...
\begin{center}
  ...
  \subfigure[Minimum \ce{H}-\ce{Mg} distance]{
    ...
    \parbox{0.85\linewidth}{
      \caption{
For each PES, the distances between the \ce{H} atoms of the rotating \ce{BH4} unit to the neighbouring \ce{Mg} atoms is plotted.
