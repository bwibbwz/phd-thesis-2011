...
The calculations were carried out using the same packages as before (\fref{sec:borohydrides-calcium}), ASE and Dacapo.
...
The experimental results indicated that $\mytilde 15\%$ of the hydrogen would move at a lower temperature than the others which is consistent with the lowest theoretical barrier which applied to $12.5\%$ of the hydrogen ($1/8$th as can be seen table 1 of paper \ref{pap:magensium}).
