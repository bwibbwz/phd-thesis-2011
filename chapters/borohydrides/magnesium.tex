...
\begin{figure}[h]
\begin{center}
  \subfigure[The rotational energy barriers for \ce{BH4} in $\beta$-\ce{Mg(BH4)2}][\footnote{Figure 17 from paper \ref{pap:magnesium}.}
...
A clear linear relationship (the line) can be seen for the $C_2$ axes.
  ...
  \subfigure[Comparison of the experimental and theoretical results][\footnote{Figure 11 from paper \ref{pap:magnesium}.}
