...
The symmetry inequivilance stems from the fact that each \ce{BH4} is slightly displaced from the \ce{Mg}-\ce{Mg} axis.
The distance, $L$, from the \ce{B} to the axis, influences the barriers.

\begin{figure}
\begin{center}
%\figmiss{Environment, for explaining the axes used}
    \includegraphics[width=0.7\linewidth]{mg-local-structure}
