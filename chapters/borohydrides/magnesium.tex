...
\begin{center}
  \subfigure[asdf][asdf]{
    \includegraphics[width=0.3\linewidth]{h-mg-distances-tot}
    \label{fig:h-mg-distances}
    }
  \subfigure[qwer][qwer]{
    \includegraphics[width=0.3\linewidth]{h-mg-distances-avg}
    \label{fig:ca-barriers}
    }
  \subfigure[zxcv][zxcv]{
    \includegraphics[width=0.3\linewidth]{h-mg-distances-min}
    \label{fig:ca-barriers}
    }
