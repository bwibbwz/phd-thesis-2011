...
The reaction rate, $k_\text{TST}$, is defined as the probability of being in the $\ts$ subsapce of $\text{R}$,
...
Some efforts have been put into searching for optimal $\ts$s~\citemiss but these generally require costly free energy calculations.
\tred{This bit needs expansion if it is to be included.}
