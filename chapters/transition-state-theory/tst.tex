...
\bit
\item Some efforts have been put into searching for optimal $\ts$s~\citemiss but these generally require costly free energy calculations. \tred{Work on this or remove?}
\eit
