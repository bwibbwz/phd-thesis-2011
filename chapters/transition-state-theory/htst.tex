...
E_\text{R}(\vect{q}_\text{R}) \approx E(\vR_\text{min}) + \frac{1}{2} \sum_i^{3N} k_{\text{min},i} q_{\text{R},i}^2,
\eeq
...
Rearrangement of \fref{eq:htst-reaction-rate-raw}, along with the multiplication of $\mu_i$ for each normal mode on both sides of the fraction, yields,
\beq{htst-reaction-rate-cleaned}
k_\text{HTST} = (2\pi)^{-1} \frac{\prod_i^{3N} \sqrt{\frac{k_{\text{min},i}}{\mu_i}}}{\prod_i^{3N-1} \sqrt{\frac{k_{\ts,i}}{\mu_i}}}
...
\nu_\text{*} = \sqrt{\frac{k_\text{*}}{\mu_\text{*}}}(2\pi)^{-1},
\eeq
