...
%\section*{\tred{Incomplete additions}}

%\tred{Everything below needs much work but is not terribly important in this section.}
...
%Albeit, the meaning is seldom lost, understanding and knowing the difference is important, particularly when the validity of HTST is discussed and higher order \sap{}s are mentioned.

%The popularity of the harmonic approximation to TST and that finding the \sap{1}\footnote{and the associated vibrational frequencies.} in question is enough to form the reaction rate has caused 

% a common misconception is that saddle points and transition states are interchangeable terms.
