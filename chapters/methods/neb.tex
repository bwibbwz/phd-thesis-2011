...
The tangent, $\uvt$, is the unit vector pointing towards the neighboring, higher function value, image, $i+1$ (\fref{eq:neb-tangent-plus, eq:neb-tangent-minus, eq:neb-tangent-minmax}).
}
