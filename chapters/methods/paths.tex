...
The MEP's formal definition is generally the same as for any SDP (\fref{sdp-definition}) but with the added criteria that the energy must be at a minimum perpendicular to the path~\cite{neb-polemic-henkelman1},
\beq{mep-definition}
\text{\expand}
\eeq
