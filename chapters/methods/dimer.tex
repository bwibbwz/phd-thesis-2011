...
A setup phase, which typically includes randomly displacing $\vR$~\citemiss is also required if the search starts from a minimum (or any other stationary point).
...
It is possible to use previous calculations of either end point to extrapolate the rotated values.\citemiss
...
This along with a fixed, artificially large, step size should yield less iterations spent near minima and more near \sap1s.~\cite{dimer-original-1999}~\citemiss
