...
Given only an initial point, $\vR$, on a multidimensional function, $F(\vR)$, the goal is to locate a nearby \sap1, using no direct calculation of the Hessian, i.e. using only functional values and the first derivatives.
