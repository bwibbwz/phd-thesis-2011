...
This allows a re-formulation of the Schrodinger equation, shows the energy as a functional of the electron density, $E[\rho(\vr)] = \bra \Psi(\rho) | \widehat{H} | \Psi(\rho) \ket$. \tred{Is this accurate?}
...
This work alone is still missing key elements in order to efficiently solve/approximate the wavefunction and energy \expand Enter K-S.
