...
According to the Hohenberg-Kohn theorem~\citemiss there is a one-to-one correspondence between the wavefunction and the electron density of the ground state.
