...
The Schr\"odinger equation is the quantum analoge of Newton's equations of motion and thus governs the motions of the quantum system in question and its observables.
\expand

The Born-Oppenheimer approximation (\fref{sec:born-oppenheimer}) allows the separation of Hamiltonian to an electronic part and a nuclear part.\expand
\expand

%\subsubsection{The Schr\"odinger equation}
%\label{sec:methods-schrodinger}
