...
According to the Hohenberg-Kohn theorem~\cite{hohenberg-kohn-1964} there is a one-to-one correspondence between the wavefunction and the electron density of the ground state or that any external term, $V_\text{ext}$, in \fref{eq:hamiltonian} yields a different electron density from any other $V'_\text{ext}$
