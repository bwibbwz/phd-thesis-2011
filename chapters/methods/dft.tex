...
According to the Hohenberg-Kohn theorem~\cite{hohenberg-kohn-1964} there is a one-to-one correspondence between the wavefunction and the electron density of the ground state.
